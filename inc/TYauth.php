...
class TYAuthV2 {
	 ...
	 * @ignore
	 */
	public $host = "https://oauth.api.189.cn/emp/oauth2/v2/authorize";
	/**
	 * Set timeout default.
	 *
	 * @ignore
	 ...
	 * @ignore
	 */
	function accessTokenURL()  { return 'https://oauth.api.189.cn/emp/oauth2/v2/access_token'; }
	/**
	 * @ignore
	 */
	 ...
	 */
	function __construct($app_id, $app_secret, $access_token = NULL, $refresh_token = NULL) {
		$this->app_id = $app_id;
